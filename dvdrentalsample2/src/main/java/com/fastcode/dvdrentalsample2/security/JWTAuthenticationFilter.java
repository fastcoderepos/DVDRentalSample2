...
import com.fastcode.dvdrentalsample2.domain.core.authorization.jwtentity.IJwtRepository;
import com.fastcode.dvdrentalsample2.domain.core.authorization.jwtentity.JwtEntity;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(
        ...
        if (user != null && (user.getIsEmailConfirmed() == null || !user.getIsEmailConfirmed())) {
            out.println("{");
            out.println("\"message\":" + "\"User email is not confirmed\",");
            out.println("\"status\":" + "\"EmailNotConfirmed\"");
            out.println("}");
            out.close();
            return;
        } else {
