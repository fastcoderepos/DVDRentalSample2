package com.fastcode.dvdrentalsample2.addons.scheduler.application.trigger;

import com.fastcode.dvdrentalsample2.addons.scheduler.application.trigger.dto.*;
...
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.trigger.ITriggerRepository;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.trigger.QTriggerEntity;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.trigger.TriggerEntity;
...
public class TriggerAppService implements ITriggerAppService {
    ...
    protected ITriggerRepository triggerDetailsRepository;
    ...
    public List<GetTriggerOutput> listAllTriggers(SearchCriteria search, Pageable pageable) throws Exception {
        ...
        Page<TriggerEntity> foundTriggers = triggerDetailsRepository.findAll(searchTriggerDetails(search), pageable);
    ...
    public List<GetJobOutput> executionHistoryByTrigger(String triggerName, String triggerGroup) {
        List<JobHistoryEntity> jobList = jobHistoryRepository.findByTrigger(triggerName, triggerGroup);
