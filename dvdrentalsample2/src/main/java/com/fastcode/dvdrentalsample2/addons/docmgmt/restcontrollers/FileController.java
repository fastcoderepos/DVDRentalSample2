package com.fastcode.dvdrentalsample2.addons.docmgmt.restcontrollers;

import com.fastcode.dvdrentalsample2.addons.docmgmt.application.file.IFileAppService;
import com.fastcode.dvdrentalsample2.addons.docmgmt.application.file.IFileMapper;
import com.fastcode.dvdrentalsample2.addons.docmgmt.application.file.dto.*;
import com.fastcode.dvdrentalsample2.addons.docmgmt.domain.file.FileEntity;
import com.fastcode.dvdrentalsample2.addons.docmgmt.domain.file.IFileContentStore;
import com.fastcode.dvdrentalsample2.addons.docmgmt.domain.file.IFileRepository;
...
public class FileController {
    ...
    @RequestMapping(value = "/file/{id}", method = RequestMethod.DELETE, consumes = { "application/json" })
    ...
    @PreAuthorize("hasAnyAuthority('FILEENTITY_CREATE')")
    @ResponseStatus(value = HttpStatus.NO_CONTENT)
    @RequestMapping(value = "/file/content/{fileId}", method = RequestMethod.PUT, consumes = { "multipart/form-data" })
    ...
    @PreAuthorize("hasAnyAuthority('FILEENTITY_DELETE')")
    @ResponseStatus(value = HttpStatus.NO_CONTENT)
    @RequestMapping(value = "/file/content/{fileId}", method = RequestMethod.DELETE, consumes = { "application/json" })
    ...
    @PreAuthorize("hasAnyAuthority('VERSION_READ')")
    @RequestMapping(
        value = "/file/findAllVersionsLatest",
        method = RequestMethod.GET,
        consumes = { "application/json" },
        produces = { "application/hal+json" }
    )
