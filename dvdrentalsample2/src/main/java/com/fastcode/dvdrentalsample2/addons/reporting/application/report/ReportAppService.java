package com.fastcode.dvdrentalsample2.addons.reporting.application.report;

import com.fastcode.dvdrentalsample2.addons.reporting.application.report.dto.*;
import com.fastcode.dvdrentalsample2.addons.reporting.application.reportversion.IReportversionAppService;
import com.fastcode.dvdrentalsample2.addons.reporting.application.reportversion.IReportversionMapper;
import com.fastcode.dvdrentalsample2.addons.reporting.application.reportversion.dto.CreateReportversionInput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.reportversion.dto.CreateReportversionOutput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.reportversion.dto.UpdateReportversionInput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.reportversion.dto.UpdateReportversionOutput;
...
import com.fastcode.dvdrentalsample2.addons.reporting.domain.report.QReportEntity;
...
public class ReportAppService implements IReportAppService {
    ...
    public FindReportByIdOutput findById(Long reportId) {
        ...
        ReportversionEntity reportversion = _reportversionRepository
            .findById(new ReportversionId(foundReport.getUser().getId(), foundReport.getId(), "running"))
            .orElse(null);
    ...
    public FindReportByIdOutput findByReportIdAndUserId(Long reportId, Long userId, String version) {
        ReportEntity foundReport = _reportRepository.findByReportIdAndUserId(reportId, userId);
        if (foundReport == null) {
            return null;
        }
    ...
    public List<ReportDetailsOutput> getReports(Long userId, String search, Pageable pageable) throws Exception {
        Page<ReportDetailsOutput> foundReport = _reportRepository.getAllReportsByUserId(userId, search, pageable);
    ...
    public List<FindReportByIdOutput> find(SearchCriteria search, Pageable pageable) throws Exception {
        ...
        while (reportIterator.hasNext()) {
            ...
            ReportversionEntity reportVersion = _reportversionRepository
                .findById(new ReportversionId(report.getUser().getId(), report.getId(), "running"))
                .orElse(null);
