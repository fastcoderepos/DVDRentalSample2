package com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion;

import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.dto.*;
...
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversion.QDashboardversionEntity;
...
public class DashboardversionAppService implements IDashboardversionAppService {
    ...
    public List<FindDashboardversionByIdOutput> find(SearchCriteria search, Pageable pageable) throws Exception {
        Page<DashboardversionEntity> foundDashboardversion = _dashboardversionRepository.findAll(
            search(search),
            pageable
        );
