package com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversionreport;

import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboard.dto.CreateDashboardOutput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversionreport.dto.*;
...
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversionreport.QDashboardversionreportEntity;
...
public class DashboardversionreportAppService implements IDashboardversionreportAppService {
    ...
    public Boolean addReportsToDashboardRunningversion(
        ...
        List<DashboardversionreportEntity> list = _reportdashboardRepository.findByDashboardIdAndVersionAndUserIdInDesc(
