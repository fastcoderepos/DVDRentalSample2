package com.fastcode.dvdrentalsample2.addons.scheduler.application.job;

import com.fastcode.dvdrentalsample2.Dvdrentalsample2Application;
import com.fastcode.dvdrentalsample2.addons.scheduler.CGenClassLoader;
import com.fastcode.dvdrentalsample2.addons.scheduler.application.job.dto.*;
import com.fastcode.dvdrentalsample2.addons.scheduler.constants.QuartzConstants;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.job.JobEntity;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.dvdrentalsample2.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
...
public class JobAppService implements IJobAppService {
    ...
    public List<String> listAllJobClasses() throws URISyntaxException {
        ...
        URI uri = Dvdrentalsample2Application.class.getResource("/").toURI();
        ...
        if (src != null) {
            ...
            try {
                ...
                while ((ze = zip.getNextEntry()) != null) {
                    ...
                    if (
                        entryName.startsWith("BOOT-INF/classes" + path + "/") ||
                        entryName.startsWith("WEB-INF/classes" + path + "/")
                    ) {
                        entryName = entryName.replace("WEB-INF/classes/", "");
                        if (entryName.contains(".class")) {
                            list.add(entryName.replace(".class", ""));
                        }
                    }
                }
            } catch (IOException e) {
