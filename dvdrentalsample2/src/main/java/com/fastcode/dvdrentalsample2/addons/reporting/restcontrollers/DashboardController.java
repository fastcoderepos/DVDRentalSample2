package com.fastcode.dvdrentalsample2.addons.reporting.restcontrollers;

import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboard.IDashboardAppService;
...
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversionreport.dto.FindDashboardversionreportByIdOutput;
...
import com.fastcode.dvdrentalsample2.commons.search.OffsetBasedPageRequest;
...
public class DashboardController {
    ...
    public ResponseEntity<UpdateDashboardOutput> update(
        ...
        output.setReportDetails(_dashboardAppService.setReportsList(Long.valueOf(id), user.getId(), "running"));
        return new ResponseEntity(output, HttpStatus.OK);
    }
    ...
    public ResponseEntity<FindDashboardByIdOutput> getPublishedVersion(@PathVariable String id) {
        ...
        Optional
            .ofNullable(output)
            .orElseThrow(() -> new EntityNotFoundException(String.format("Dashboard with id=%s not found.", id)));
        output.setReportDetails(_dashboardAppService.setReportsList(Long.valueOf(id), user.getId(), "published"));
    ...
    public ResponseEntity<FindDashboardByIdOutput> addExistingReportsToExistingDasboard(
        ...
        dashboard.setReportDetails(_dashboardAppService.setReportsList(input.getId(), user.getId(), "running"));
    ...
    public ResponseEntity<FindDashboardByIdOutput> publishDashboard(@PathVariable String id) {
        ...
        output.setReportDetails(_dashboardAppService.setReportsList(output.getId(), user.getId(), "running"));
