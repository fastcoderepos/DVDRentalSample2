package com.fastcode.dvdrentalsample2.addons.reporting.application.dashboard;

import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboard.dto.*;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.IDashboardversionAppService;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.IDashboardversionMapper;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.dto.CreateDashboardversionInput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.dto.CreateDashboardversionOutput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.dto.UpdateDashboardversionInput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversion.dto.UpdateDashboardversionOutput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.dashboardversionreport.IDashboardversionreportAppService;
import com.fastcode.dvdrentalsample2.addons.reporting.application.report.IReportAppService;
import com.fastcode.dvdrentalsample2.addons.reporting.application.report.IReportMapper;
import com.fastcode.dvdrentalsample2.addons.reporting.application.report.dto.CreateReportInput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.report.dto.CreateReportOutput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.report.dto.FindReportByIdOutput;
import com.fastcode.dvdrentalsample2.addons.reporting.application.report.dto.UpdateReportInput;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboard.DashboardEntity;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboard.IDashboardRepository;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboard.QDashboardEntity;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversion.DashboardversionEntity;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversion.DashboardversionId;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversion.IDashboardversionRepository;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversionreport.DashboardversionreportEntity;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversionreport.DashboardversionreportId;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.dashboardversionreport.IDashboardversionreportRepository;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.report.IReportRepository;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.report.ReportEntity;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.reportversion.IReportversionRepository;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.reportversion.ReportversionEntity;
import com.fastcode.dvdrentalsample2.addons.reporting.domain.reportversion.ReportversionId;
import com.fastcode.dvdrentalsample2.commons.logging.LoggingHelper;
import com.fastcode.dvdrentalsample2.commons.search.*;
import com.fastcode.dvdrentalsample2.domain.core.authorization.user.UserEntity;
...
public class DashboardAppService implements IDashboardAppService {
    ...
    public UpdateDashboardOutput update(Long dashboardId, UpdateDashboardInput input) {
        ...
        for (UpdateReportInput reportInput : input.getReportDetails()) {
            DashboardversionreportEntity dashboardreport = _reportDashboardRepository
    ...
    public List<FindReportByIdOutput> setReportsList(Long dashboardId, Long userId, String version) {
        List<DashboardversionreportEntity> reportDashboardList = _reportDashboardRepository.findByDashboardIdAndVersionAndUserId(
            dashboardId,
            version,
            userId
        );
    ...
    public List<DashboardDetailsOutput> getDashboards(Long userId, String search, Pageable pageable) throws Exception {
        Page<DashboardDetailsOutput> foundDashboard = _dashboardRepository.getAllDashboardsByUserId(
            userId,
            search,
            pageable
        );
    ...
    public List<DashboardDetailsOutput> getAvailableDashboards(
        ...
        Page<DashboardDetailsOutput> foundDashboard = _dashboardRepository.getAvailableDashboardsByUserId(
            userId,
            reportId,
            search,
            pageable
    ...
    public FindDashboardByIdOutput publishDashboard(Long userId, Long dashboardId) {
        ...
        DashboardversionEntity foundDashboardversion = _dashboardversionRepository
            .findById(new DashboardversionId(userId, dashboardId, "running"))
            .orElse(null);
        DashboardversionEntity foundPublishedversion = _dashboardversionRepository
        ...
        List<DashboardversionreportEntity> dashboardreportList = _reportDashboardRepository.findByDashboardIdAndVersionAndUserId(
            dashboardId,
            "running",
            userId
        );
        ...
        for (DashboardversionreportEntity dashboardreport : dashboardreportList) {
            DashboardversionreportEntity publishedDashboardreport = _reportDashboardRepository
        ...
        List<DashboardversionreportEntity> dashboardPublishedreportList = _reportDashboardRepository.findByDashboardIdAndVersionAndUserId(
            dashboardId,
            "published",
            userId
        );
        ...
        for (DashboardversionreportEntity dashboardeport : dashboardPublishedreportList) {
            DashboardversionreportEntity runningDashboardreport = _reportDashboardRepository
    ...
    public FindDashboardByIdOutput refreshDashboard(Long userId, Long dashboardId) {
        ...
        if (foundDashboard != null && foundDashboard.getUser() != null && foundDashboard.getUser().getId() == userId) {
            DashboardversionEntity ownerPublishedversion = _dashboardversionRepository
                .findById(new DashboardversionId(userId, dashboardId, "published"))
                .orElse(null);
            DashboardversionEntity ownerRunningversion = _dashboardversionRepository
                .findById(new DashboardversionId(userId, dashboardId, "running"))
                .orElse(null);
            ...
            List<DashboardversionreportEntity> dvrList = _reportDashboardRepository.findByDashboardIdAndVersionAndUserId(
                dashboardId,
                "published",
                userId
            );
            ...
            DashboardversionEntity runningversion = _dashboardversionRepository
                .findById(new DashboardversionId(userId, dashboardId, "running"))
                .orElse(null);
    ...
    public List<FindDashboardByIdOutput> find(SearchCriteria search, Pageable pageable) throws Exception {
        ...
        while (dashboardIterator.hasNext()) {
            ...
            DashboardversionEntity dashboardVersion = _dashboardversionRepository
                .findById(new DashboardversionId(dashboard.getUser().getId(), dashboard.getId(), "running"))
                .orElse(null);
            FindDashboardByIdOutput dashboardOutput = mapper.dashboardEntitiesToFindDashboardByIdOutput(
                dashboard,
                dashboardVersion
            );
            DashboardversionEntity publishedversion = _dashboardversionRepository
                .findById(new DashboardversionId(dashboard.getUser().getId(), dashboard.getId(), "published"))
                .orElse(null);
    ...
    public FindDashboardByIdOutput addExistingReportsToNewDashboard(AddExistingReportToNewDashboardInput input) {
        ...
        for (ExistingReportInput report : input.getReportDetails()) {
            ...
            ReportversionEntity reportversionEntity = _reportversionRepository
    ...
    public FindDashboardByIdOutput addExistingReportsToExistingDashboard(
        ...
        for (ExistingReportInput report : input.getReportDetails()) {
            ReportEntity reportEntity = _reportRepository.findById(report.getId()).orElse(null);
            ReportversionEntity reportversionEntity = _reportversionRepository
                .findById(new ReportversionId(input.getOwnerId(), reportEntity.getId(), "published"))
                .orElse(null);
            if (reportversionEntity == null) {
                reportversionEntity =
                    _reportversionRepository
                        .findById(new ReportversionId(input.getOwnerId(), reportEntity.getId(), "running"))
                        .orElse(null);
            }
