package com.fastcode.dvdrentalsample2.application.core.film;
...
import com.fastcode.dvdrentalsample2.domain.core.film.*;
import com.fastcode.dvdrentalsample2.domain.core.film.FilmEntity;
import com.fastcode.dvdrentalsample2.domain.core.film.QFilmEntity;
...
public class FilmAppServiceTest {
    ...
    public void GetLanguage_IfFilmIdAndLanguageIdIsNotNullAndFilmExists_ReturnLanguage() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.languageEntityToGetLanguageOutput(languageEntity, film));
    }
