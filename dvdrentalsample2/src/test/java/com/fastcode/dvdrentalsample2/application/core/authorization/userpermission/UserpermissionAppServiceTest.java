package com.fastcode.dvdrentalsample2.application.core.authorization.userpermission;
...
import com.fastcode.dvdrentalsample2.application.core.authorization.userpermission.dto.*;
...
import com.fastcode.dvdrentalsample2.domain.core.authorization.permission.PermissionEntity;
...
import com.fastcode.dvdrentalsample2.domain.core.authorization.userpermission.*;
import com.fastcode.dvdrentalsample2.domain.core.authorization.userpermission.QUserpermissionEntity;
import com.fastcode.dvdrentalsample2.domain.core.authorization.userpermission.UserpermissionEntity;
import com.fastcode.dvdrentalsample2.domain.core.authorization.userpermission.UserpermissionId;
...
public class UserpermissionAppServiceTest {
    ...
    public void findUserpermissionById_IdIsNotNullAndIdExists_ReturnUserpermission() {
        ...
        Mockito
            .when(_userpermissionRepository.findById(any(UserpermissionId.class)))
            .thenReturn(userpermissionOptional);
    ...
    public void GetPermission_IfUserpermissionIdAndPermissionIdIsNotNullAndUserpermissionExists_ReturnPermission() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.permissionEntityToGetPermissionOutput(permissionEntity, userpermission));
    }
    ...
    public void GetUser_IfUserpermissionIdAndUserIdIsNotNullAndUserpermissionExists_ReturnUser() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.userEntityToGetUserOutput(userEntity, userpermission));
    }
