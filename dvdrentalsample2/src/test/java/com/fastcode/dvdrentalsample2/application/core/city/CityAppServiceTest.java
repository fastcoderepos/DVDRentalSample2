...
import com.fastcode.dvdrentalsample2.domain.core.city.*;
import com.fastcode.dvdrentalsample2.domain.core.city.CityEntity;
import com.fastcode.dvdrentalsample2.domain.core.city.QCityEntity;
...
public class CityAppServiceTest {
    ...
    public void GetCountry_IfCityIdAndCountryIdIsNotNullAndCityExists_ReturnCountry() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.countryEntityToGetCountryOutput(countryEntity, city));
    }
