package com.fastcode.dvdrentalsample2.application.core.customer;
...
import com.fastcode.dvdrentalsample2.domain.core.customer.*;
import com.fastcode.dvdrentalsample2.domain.core.customer.CustomerEntity;
import com.fastcode.dvdrentalsample2.domain.core.customer.QCustomerEntity;
...
public class CustomerAppServiceTest {
    ...
    public void GetAddress_IfCustomerIdAndAddressIdIsNotNullAndCustomerExists_ReturnAddress() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.addressEntityToGetAddressOutput(addressEntity, customer));
    }
