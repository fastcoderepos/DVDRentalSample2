package com.fastcode.dvdrentalsample2.application.core.authorization.user;
...
import com.fastcode.dvdrentalsample2.application.core.authorization.user.dto.*;
...
import com.fastcode.dvdrentalsample2.domain.core.authorization.user.*;
import com.fastcode.dvdrentalsample2.domain.core.authorization.user.QUserEntity;
...
import com.fastcode.dvdrentalsample2.domain.core.authorization.userpreference.UserpreferenceEntity;
...
public class UserAppServiceTest {
    ...
    public void deleteUser_UserIsNotNullAndUserExists_UserRemoved() {
        ...
        Mockito.when(_reportDashboardRepository.findByUserId(anyLong())).thenReturn(dvrList);

        List<DashboardversionEntity> dvList = new ArrayList<>();
        Mockito.when(_dashboardversionRepository.findByUserId(anyLong())).thenReturn(dvList);

        List<ReportversionEntity> rvList = new ArrayList<>();
        Mockito.when(_reportversionRepository.findByUserId(anyLong())).thenReturn(rvList);
