package com.fastcode.dvdrentalsample2.application.core.inventory;
...
import com.fastcode.dvdrentalsample2.domain.core.inventory.*;
import com.fastcode.dvdrentalsample2.domain.core.inventory.InventoryEntity;
import com.fastcode.dvdrentalsample2.domain.core.inventory.QInventoryEntity;
...
public class InventoryAppServiceTest {
    ...
    public void GetFilm_IfInventoryIdAndFilmIdIsNotNullAndInventoryExists_ReturnFilm() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.filmEntityToGetFilmOutput(filmEntity, inventory));
    }
