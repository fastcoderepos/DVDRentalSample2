package com.fastcode.dvdrentalsample2.application.core.store;
...
import com.fastcode.dvdrentalsample2.application.core.store.dto.*;
...
import com.fastcode.dvdrentalsample2.domain.core.store.*;
import com.fastcode.dvdrentalsample2.domain.core.store.QStoreEntity;
...
public class StoreAppServiceTest {
    ...
    public void createStore_StoreIsNotNullAndStoreDoesNotExist_StoreStore() {
        ...
        storeInput.setManagerStaffId(15);
