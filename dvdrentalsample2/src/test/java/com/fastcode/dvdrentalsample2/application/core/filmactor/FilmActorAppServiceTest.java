package com.fastcode.dvdrentalsample2.application.core.filmactor;
...
import com.fastcode.dvdrentalsample2.application.core.filmactor.dto.*;
...
import com.fastcode.dvdrentalsample2.domain.core.filmactor.*;
import com.fastcode.dvdrentalsample2.domain.core.filmactor.FilmActorEntity;
import com.fastcode.dvdrentalsample2.domain.core.filmactor.FilmActorId;
import com.fastcode.dvdrentalsample2.domain.core.filmactor.QFilmActorEntity;
...
public class FilmActorAppServiceTest {
    ...
    public void GetActor_IfFilmActorIdAndActorIdIsNotNullAndFilmActorExists_ReturnActor() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.actorEntityToGetActorOutput(actorEntity, filmActor));
    }
    ...
    public void GetFilm_IfFilmActorIdAndFilmIdIsNotNullAndFilmActorExists_ReturnFilm() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.filmEntityToGetFilmOutput(filmEntity, filmActor));
    }
