package com.fastcode.dvdrentalsample2.application.core.staff;
...
import com.fastcode.dvdrentalsample2.domain.core.staff.*;
import com.fastcode.dvdrentalsample2.domain.core.staff.QStaffEntity;
...
public class StaffAppServiceTest {
    ...
    public void GetAddress_IfStaffIdAndAddressIdIsNotNullAndStaffExists_ReturnAddress() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.addressEntityToGetAddressOutput(addressEntity, staff));
    }
