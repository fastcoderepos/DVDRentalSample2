package com.fastcode.dvdrentalsample2.application.core.address;
...
import com.fastcode.dvdrentalsample2.domain.core.address.*;
import com.fastcode.dvdrentalsample2.domain.core.address.AddressEntity;
import com.fastcode.dvdrentalsample2.domain.core.address.QAddressEntity;
...
public class AddressAppServiceTest {
    ...
    public void GetCity_IfAddressIdAndCityIdIsNotNullAndAddressExists_ReturnCity() {
        ...
        Assertions
            ...
            .isEqualTo(_mapper.cityEntityToGetCityOutput(cityEntity, address));
    }
