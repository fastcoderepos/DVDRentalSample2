...
import com.fastcode.dvdrentalsample2.domain.core.authorization.userpreference.IUserpreferenceManager;
...
public class UserControllerTest {
    ...
    public static void cleanup() {
        ...
        em.createNativeQuery("truncate table dvdrental.userpreference").executeUpdate();
    ...
    public void FindById_IdIsValid_ReturnStatusOk() throws Exception {
        mvc
            .perform(get("/user/" + user.getId() + "/").contentType(MediaType.APPLICATION_JSON))
