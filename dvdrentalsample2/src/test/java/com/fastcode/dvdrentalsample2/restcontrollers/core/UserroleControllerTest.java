...
import com.fastcode.dvdrentalsample2.application.core.authorization.userrole.UserroleAppService;
import com.fastcode.dvdrentalsample2.application.core.authorization.userrole.dto.*;
...
import com.fastcode.dvdrentalsample2.domain.core.authorization.userrole.UserroleId;
...
public class UserroleControllerTest {
    ...
    public static void cleanup() {
        ...
        em.createNativeQuery("truncate table dvdrental.userrole").executeUpdate();
        em.createNativeQuery("truncate table dvdrental.role").executeUpdate();
